...
def parse(source_file: str = None, source_code: str = None, message_only: bool = False, debug: int = 0):
    ...
    demo = Base([Group([Refer("""NEWLINE""")], [Refer("""stmt""")], [Refer("""TEXT""")]), Group([Refer("""NEWLINE""")])], name='demo')
